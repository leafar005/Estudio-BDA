document.addEventListener('DOMContentLoaded', () => {
  ...
  const titles = {
    'catalogo': 'Catálogo y Diccionario',
    'vistas': 'Vistas y Vistas Materializadas',
    'integridade': 'Integridad Referencial',
    'seguridade': 'Seguridad y Permisos',
    'activas': 'Bases de Datos Activas (Triggers)',
    'desenofisico': 'Diseño Físico',
    'optimizacion': 'Optimización de Consultas',
    'recuperacion': 'Recuperación ante fallos',
    'concorrencia': 'Control de Concurrencia',
    'examen': 'Exámenes Prácticos'
  };
  ...
  // (Desactivado por petición del usuario para mantener el orden por temas)
  /*
  if (!topic) {
