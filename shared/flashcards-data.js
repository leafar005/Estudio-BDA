window.FlashcardsData = {
  ...
  "oorm": [
    {
      "q": "¿Qué niveles conforman la arquitectura ANSI/SPARC?",
      "a": "Nivel externo (vistas), nivel conceptual (esquema) y nivel físico/interno (ficheros, bloques)."
    },
    {
      "q": "¿Cuál es la diferencia entre el nivel lógico y físico de los datos?",
      "a": "El nivel lógico trata con tablas, vistas y SQL. El nivel físico trata con ficheros, bloques, extensiones e índices."
    },
    {
      "q": "¿Qué es una zona lógica (tablespace) en almacenamiento?",
      "a": "Es el contenedor de estructuración lógica máximo, formado físicamente por uno o varios ficheros de datos (datafiles)."
    },
    {
      "q": "Nombra los tablespaces predeterminados creados por Oracle.",
      "a": "SYSTEM, SYSAUX, UNDOTBS1, TEMP y USERS."
    },
    {
      "q": "¿Qué es un segmento (segment) en almacenamiento?",
      "a": "Conjunto de datos asociados a un único objeto lógico (tabla o índice). Pertenece a un único tablespace."
    },
    {
      "q": "¿Qué es una extensión (extent) en almacenamiento?",
      "a": "Es la unidad básica de asignación de espacio físico, consistente en un conjunto de bloques contiguos dentro de un fichero."
    },
    {
      "q": "¿Qué es un bloque de base de datos o página?",
      "a": "Unidad mínima de transferencia de E/S entre el disco físico y la memoria RAM (Buffer Cache). Típicamente de 8KB."
    },
    {
      "q": "¿Qué caracteriza a una Heap Table (Tabla Apilada)?",
      "a": "Las filas se insertan desordenadamente en bloques libres. Las inserciones son muy eficientes, pero las búsquedas son ineficientes."
    },
    {
      "q": "¿Cuándo es eficiente realizar un Full Table Scan (Exploración Completa)?",
      "a": "Cuando la consulta tiene una selectividad muy baja (devuelve un alto porcentaje del volumen total de la tabla)."
    },
    {
      "q": "¿Qué es un índice en bases de datos?",
      "a": "Una estructura auxiliar que permite acceso rápido a los registros usando la clave de indexación y evitando un Full Table Scan."
    },
    {
      "q": "¿Cuál es el tipo de índice predeterminado en la mayoría de SGBDs?",
      "a": "El árbol B+ (INDEX_TYPE='NORMAL')."
    },
    {
      "q": "¿Qué almacena un nodo hoja de un árbol B+ convencional?",
      "a": "Valores de la clave de indexación de forma ordenada junto con un puntero físico directo (ROWID) a la fila en la tabla."
    },
    {
      "q": "¿Verdadero o falso? Oracle indexa los valores NULL en un árbol B+ convencional.",
      "a": "Falso. Si todas las columnas de la clave son nulas, no se genera ninguna entrada en el índice B+."
    },
    {
      "q": "¿Qué es un índice denso?",
      "a": "Aquel en el que existe obligatoriamente una entrada en el índice por cada fila de la tabla."
    },
    {
      "q": "¿Qué es un índice disperso?",
      "a": "Aquel donde existe una entrada por bloque o agrupación, requiriendo que la tabla base esté físicamente ordenada."
    },
    {
      "q": "¿Qué es un índice agrupado (Clustered Index en SQL Server)?",
      "a": "Un índice donde la tabla física se ordena siguiendo estrictamente la secuencia de la clave del índice. Solo puede haber uno por tabla."
    },
    {
      "q": "¿Para qué se utiliza un índice REVERSE en Oracle?",
      "a": "Para invertir los bytes de la clave y evitar embotellamientos (hot blocks) al insertar identificadores secuenciales concurrentes. Anula búsquedas por rango."
    },
    {
      "q": "¿Cuándo es ideal utilizar un índice BITMAP?",
      "a": "Para columnas de muy baja cardinalidad (ej. género, país) en entornos analíticos y de Data Warehouse (OLAP)."
    },
    {
      "q": "¿Por qué no usar índices BITMAP en un entorno OLTP transaccional?",
      "a": "Porque las modificaciones DML (INSERT/UPDATE) tienen un impacto devastador, bloqueando segmentos enteros de datos simultáneamente."
    },
    {
      "q": "¿Qué ventaja ofrecen los índices basados en funciones?",
      "a": "Permiten indexar el resultado precalculado de una expresión matemática o de cadena (ej. UPPER(nombre), salario*1.2)."
    },
    {
      "q": "¿Qué es una Tabla Organizada por Índice (IOT) en Oracle?",
      "a": "Una tabla donde la propia Heap Table desaparece y todos los datos de la fila se guardan directamente en los nodos hoja del árbol B+ de la clave primaria."
    },
    {
      "q": "Nombra una desventaja importante de las IOT.",
      "a": "Las operaciones DML son pesadas por costosos rebalanceos en el árbol B+ y crear índices secundarios sobre la IOT penaliza el rendimiento."
    },
    {
      "q": "¿Qué es un Cluster en el diseño físico de Oracle?",
      "a": "Estructura que almacena físicamente entremezclados en los mismos bloques de disco registros de múltiples tablas distintas que comparten una clave común."
    },
    {
      "q": "¿Qué diferencia un B+-Tree Cluster de un Hash Cluster?",
      "a": "El B+-Tree usa un índice para apuntar al bloque, mientras que el Hash Cluster sustituye el índice por una función hash rápida y directa."
    },
    {
      "q": "¿Qué es el particionado de tablas?",
      "a": "Estrategia de fragmentación horizontal que divide una tabla gigante en fragmentos físicos independientes más manejables denominados particiones."
    },
    {
      "q": "Nombra los tres tipos básicos de particionado de tablas.",
      "a": "RANGE (por intervalos), LIST (categorías discretas), y HASH (distribución mediante algoritmo hash)."
    },
    {
      "q": "¿Qué diferencia hay entre un índice particionado local y global?",
      "a": "El local se fragmenta con los mismos límites y particiones que la tabla base. El global cruza los límites lógicos de las particiones de la tabla."
    },
    {
      "q": "¿Qué es el \"Partition Pruning\" (exclusión de particiones)?",
      "a": "Capacidad del optimizador de descartar completamente la lectura de particiones físicas que no cumplen el criterio de la consulta, acelerando la respuesta."
    },
    {
      "q": "¿Qué significa \"Alta Cardinalidad\" en una columna de base de datos?",
      "a": "Que la columna contiene muchos valores distintos y únicos en el dominio (ej. DNI, email). Es ideal para crear índices B-Tree."
    },
    {
      "q": "¿Cuál es la \"trampa de los nulos\" al evaluar consultas como \"SELECT COMM FROM EMP\"?",
      "a": "Si la columna COMM admite nulos, Oracle ignora cualquier índice B-Tree creado sobre ella y fuerza un Full Table Scan, porque los nulos no están indexados."
    }
  ],
  "optimizacion": [
    {
      "q": "¿Qué es el optimizador de consultas en un SGBD?",
      "a": "El componente encargado de determinar el plan de ejecución o estrategia física más eficiente para resolver una consulta SQL declarativa."
    },
    {
      "q": "Enumera las 5 fases principales de la ejecución de una consulta.",
      "a": "1. Análisis. 2. Transformación a álgebra relacional. 3. Optimización algebraica (heurística). 4. Optimización basada en costes (CBO). 5. Ejecución."
    },
    {
      "q": "¿En qué consiste la optimización algebraica (heurística)?",
      "a": "Aplica reglas de equivalencia lógicas (sin usar estadísticas de datos) para generar la forma canónica del árbol reduciendo tuplas intermedias."
    },
    {
      "q": "Menciona la regla heurística fundamental sobre las selecciones (filtros).",
      "a": "Realizar las selecciones (condiciones WHERE) lo antes posible, \"empujando\" las operaciones hacia las hojas del árbol."
    },
    {
      "q": "¿Cómo optimiza la heurística los productos cartesianos?",
      "a": "Sustituyendo siempre que sea posible un Producto Cartesiano seguido de una Selección por un operador \"Join\" directo."
    },
    {
      "q": "¿En qué se fundamenta la Optimización Basada en Costes (CBO)?",
      "a": "En evaluar planes físicos estimando matemáticamente el coste usando estadísticas del catálogo (número de filas, bloques, cardinalidad)."
    },
    {
      "q": "¿Cómo se mide el \"Coste Computacional\" en el CBO simplificado?",
      "a": "Se mide estrictamente en el número de transferencias de bloques de disco físico hacia la memoria RAM (operaciones de E/S o I/O)."
    },
    {
      "q": "¿Qué es el Factor de Bloqueo (f_R)?",
      "a": "El número promedio de filas de una tabla que pueden almacenarse dentro de un único bloque o página física en disco."
    },
    {
      "q": "¿Cuál es la fórmula del coste estimado de un Full Table Scan?",
      "a": "Coste = b_R (donde b_R es el número total de bloques de la tabla). Útil cuando la selectividad de la consulta es baja."
    },
    {
      "q": "¿Cuál es el coste estimado de una búsqueda de igualdad usando un índice primario (Unique Scan)?",
      "a": "Coste = h_idx + 1 (donde h_idx es la altura del árbol del índice y 1 es el acceso al bloque físico en tabla)."
    },
    {
      "q": "¿Cuál es el coste de búsqueda por rango usando un índice agrupado (Clustered)?",
      "a": "Coste = h_idx + m (donde m es el número de bloques de datos secuenciales que se deben leer físicamente)."
    },
    {
      "q": "¿Por qué es muy costoso usar un índice secundario para leer muchas filas dispersas?",
      "a": "Porque la tabla no está ordenada respecto al índice. Coste = h_idx - 1 + e + d (d=filas leídas), obligando a múltiples saltos de disco aleatorios."
    },
    {
      "q": "¿Qué hace la técnica combinada Bitmap Index Scan + Bitmap Heap Scan en PostgreSQL?",
      "a": "Recopila ROWIDs del índice, los ordena linealmente en RAM según su posición física y luego lee el disco de forma contigua, mitigando saltos aleatorios."
    },
    {
      "q": "En un Join, ¿a qué llamamos Tabla Externa y Tabla Interna?",
      "a": "Tabla externa = bucle exterior de control (evaluada una vez). Tabla interna = bucle interior (escaneada repetidamente por cada fila de la externa)."
    },
    {
      "q": "¿Cuál es el coste del Nested Loop Join (Bucle Anidado) en el peor escenario?",
      "a": "Coste = b_R + (n_R * b_S). Obliga a leer toda la tabla interna (b_S) por cada una de las filas de la tabla externa (n_R)."
    },
    {
      "q": "¿Qué es el Indexed Nested Loop Join y cuál es su coste?",
      "a": "Es cuando la tabla interna usa un índice B-Tree en la clave de unión. Coste = b_R + (n_R * C_indice). Reduce inmensamente el coste multiplicativo."
    },
    {
      "q": "Explica brevemente el Sort-Merge Join (Ordenación-Mezcla).",
      "a": "Ambas relaciones se ordenan independientemente por la clave común y luego se fusionan/entrelazan leyendo cada tabla linealmente una sola vez."
    },
    {
      "q": "Explica brevemente el Hash Join.",
      "a": "Construye en memoria una tabla Hash usando la tabla externa (Build Phase) y luego escanea la tabla interna grande evaluándola contra el Hash (Probe Phase)."
    },
    {
      "q": "¿Qué algoritmos de Join están limitados exclusivamente a resolver \"equijoins\" (operador de igualdad)?",
      "a": "Sort-Merge Join y Hash Join."
    },
    {
      "q": "¿Qué algoritmo de Join usará el CBO si la condición es una desigualdad (ej. >, <, !=)?",
      "a": "Invariablemente el optimizador forzará la ejecución de un algoritmo Nested Loops (Bucles Anidados)."
    },
    {
      "q": "En Oracle, ¿qué diferencia los objetivos de optimización ALL_ROWS y FIRST_ROWS_n?",
      "a": "ALL_ROWS maximiza el throughput global (rendimiento total). FIRST_ROWS_n prioriza minimizar el tiempo de respuesta inicial de las primeras n filas."
    },
    {
      "q": "¿Qué nos indica la tabulación o indentación en un informe EXPLAIN PLAN?",
      "a": "Jerarquía temporal: los nodos tabulados más a la derecha se ejecutan primero, siendo accesos a disco que alimentan (pipeline) a sus nodos padre superiores."
    },
    {
      "q": "¿Cómo afecta usar \"SELECT COUNT(salario)\" si la columna \"salario\" admite valores nulos?",
      "a": "Oracle NO podrá usar el índice B-Tree (ya que los nulos no están). Ejecutará un costoso Full Table Scan. Si se usase COUNT(*) o el campo tuviese NOT NULL, usaría INDEX FAST FULL SCAN."
    },
    {
      "q": "En un plan de ejecución, ¿qué indica el paso \"FILTER\" si está inmediatamente encima de un \"GROUP BY\"?",
      "a": "Indica inequívocamente la evaluación y filtrado lógico de la cláusula HAVING de la consulta original."
    },
    {
      "q": "¿Qué diferencia a un INDEX RANGE SCAN de un INDEX FAST FULL SCAN?",
      "a": "INDEX RANGE SCAN recorre el árbol de forma secuencial y ordenada devolviendo filas acotadas. FAST FULL SCAN lee masiva y desordenadamente los bloques de disco del índice (útil para agregaciones globales)."
    },
    {
      "q": "¿Por qué es indispensable usar periódicamente el paquete DBMS_STATS en Oracle?",
      "a": "Para actualizar el diccionario. Si las estadísticas (filas, bloques) son antiguas, el CBO tomará decisiones algorítmicas pésimas basadas en estimaciones falsas."
    },
    {
      "q": "¿Qué indica la segunda regla de optimización heurística respecto a las Proyecciones?",
      "a": "Aplicar las proyecciones lo más pronto posible para descartar columnas irrelevantes, reduciendo el tamaño en bytes de las tuplas intermedias cargadas en RAM."
    },
    {
      "q": "¿En qué caso el algoritmo \"Nested Loop Join\" (Bucle Anidado normal) es una estrategia muy eficiente?",
      "a": "Cuando la tabla externa es de tamaño extremadamente pequeño y la tabla interna cuenta con un índice rápido (Unique/Range Scan) en la condición de join."
    },
    {
      "q": "Para un \"In-memory Hash Join\", ¿cuál de las dos tablas debe ser elegida obligatoriamente como Tabla Externa?",
      "a": "La tabla de menor volumen (Build table), para garantizar que la estructura matemática del Hash quepa de forma íntegra en la memoria RAM."
    },
    {
      "q": "¿Qué ocurre si el optimizador CBO detecta que un HINT (ej. /*+ INDEX(...) */) provocaría devolver resultados falsos o incompletos?",
      "a": "El optimizador anula el HINT, tiene directiva para ignorarlo si compromete la integridad semántica de la consulta (ej. forzar índice sobre columna con nulos pidiendo todas las filas)."
    },
    {
  ...
  "recuperacion": [
    {
      "q": "¿Qué es el concepto de \"Recuperación\" en Bases de Datos?",
      "a": "Es el proceso algorítmico, basado en redundancia, que devuelve la BBDD a un estado consistente tras un fallo o corrupción."
    },
    {
      "q": "Define los tres niveles de almacenamiento físicos.",
      "a": "Volátil (se destruye al reiniciar, RAM), No Volátil (permanece sin energía pero sujeto a rotura, HDD), y Estable (utópico, la información nunca se pierde, RAID/réplicas)."
    },
    {
      "q": "Lista las propiedades fundamentales transaccionales \"ACID\".",
      "a": "Atomicidad (todo o nada), Consistencia, Aislamiento (Isolation, operaciones invisibles entre sí), y Durabilidad (Persistencia ante caídas)."
    },
    {
      "q": "En el flujo a bajo nivel, ¿qué hace la instrucción física \"Input(B)\"?",
      "a": "Lee el bloque de datos físico \"B\" del disco duro no volátil y lo inyecta en la caché de memoria RAM volátil (Buffer Cache)."
    },
    {
      "q": "¿Qué hace la instrucción física \"Output(B)\"?",
      "a": "Vuelca y consolida de forma permanente el bloque de datos modificado \"B\" desde la RAM volátil hacia el disco duro no volátil."
    },
    {
      "q": "¿Es cierto que la orden de programa \"Write(X)\" graba instantáneamente en el disco duro? (La trampa del Write)",
      "a": "No, \"Write(X)\" sólo altera los datos dentro de la memoria RAM (Buffer Cache). El vuelco diferido a disco dependerá de la instrucción Output(B)."
    },
    {
      "q": "¿En qué consiste un \"Fallo con pérdida de almacenamiento volátil (Caída del sistema)\"?",
      "a": "Interrupción repentina (apagón) que borra la memoria RAM. El disco queda inconsistente con transacciones a medias y sin los últimos commits no volcados. Se repara sólo leyendo los Logs."
    },
    {
      "q": "¿Qué se debe usar en caso de \"Fallo con pérdida de almacenamiento no volátil (Desastre de Disco)\"?",
      "a": "Se requiere instalar de cero la Base de Datos, restaurar la Copia de Seguridad Física completa (Backup) e inyectar el histórico íntegro de Archivos de Log Offline."
    },
    {
      "q": "Dictamina la \"Regla de Oro\" del protocolo WAL (Write-Ahead Logging).",
      "a": "Ningún cambio sobre datos puede grabarse físicamente en los bloques del disco sin que antes ese mismo cambio esté registrado de forma segura e inalterable en el fichero de Log (disco)."
    },
    {
      "q": "Explica las políticas Steal (Robar) y No-Force (No forzar) del Buffer.",
      "a": "Steal permite guardar bloques sucios a disco antes de que la transacción haga commit. No-Force no exige grabar a disco en el milisegundo exacto en que la transacción emite commit."
    },
    {
      "q": "¿Qué impacto tienen las políticas Steal y No-Force en la recuperación del sistema?",
      "a": "La política Steal obliga a disponer de operaciones \"UNDO\" (Deshacer). La política No-Force obliga a disponer de operaciones \"REDO\" (Rehacer)."
    },
    {
      "q": "¿Cómo es el registro en la técnica de Actualizaciones Diferidas?",
      "a": "Formato de 3 campos: <T_id, Elemento, Imagen-Posterior>. No hay Imagen Anterior porque el sistema nunca mancha el disco antes del commit."
    },
    {
      "q": "¿Se ejecutan operaciones UNDO en sistemas de Actualización Diferida?",
      "a": "No, jamás. Las transacciones fracasadas nunca tocaron físicamente el disco; simplemente se descartan ignorándolas por completo al reiniciar."
    },
    {
      "q": "¿Cómo es el registro en la técnica de Actualizaciones Inmediatas?",
      "a": "Formato de 4 campos completos: <T_id, Elemento, Imagen-Anterior, Imagen-Posterior>. Precisa los valores previos para dar soporte al UNDO de política Steal."
    },
    {
      "q": "Tras una caída en sistemas de Actualización Inmediata, ¿en qué estricto orden cronológico se efectúan las fases de recuperación?",
      "a": "Es de ejecución obligatoria realizar íntegramente la fase total de \"UNDO\" (Limpieza) en primer lugar, y solo entonces arrancar la fase \"REDO\" (Consolidación)."
    },
    {
      "q": "¿Por qué es crítico que las funciones UNDO y REDO posean propiedad \"Idempotente\"?",
      "a": "Porque ejecutar la corrección infinitas veces es igual que ejecutarla una vez. Esto permite que si la máquina vuelve a sufrir un apagón mientras el gestor recupera, el motor inicie de nuevo sin duplicar valores."
    },
    {
      "q": "Define una operación general de \"CHECKPOINT\" (Punto de Control).",
      "a": "Suspensión temporal del sistema para forzar obligatoriamente el volcado masivo (Output) al disco duro de los buffers de Log y datos de la RAM, estampando una firma en el Log."
    },
    {
      "q": "¿Qué efecto tiene una marca de CHECKPOINT sobre el procesamiento de logs?",
      "a": "Actúa como \"barrera infranqueable\": toda transacción que hubiera consolidado exitosamente su COMMIT de manera previa al checkpoint se ignora y descarta completamente, aligerando el RTO."
    },
    {
      "q": "En un Log Inmediato, ¿quién entra en la lista de castigo de la fase UNDO?",
      "a": "Cualquier transacción que refleje un START pero carezca en el historial post-caída de su orden correlativa e indispensable de COMMIT o ROLLBACK."
    },
    {
      "q": "En un Log Inmediato, ¿quién entra en la lista de consolidación de la fase REDO?",
      "a": "Únicamente aquellas transacciones que exhiben formalmente un apunte físico de COMMIT consolidado en el Log antes del momento exacto del apagón."
    },
    {
      "q": "Diferencia esencial entre \"Backup Lógico (Exportación SQL)\" y \"Backup Físico\".",
      "a": "El Lógico es texto plano de INSERTs y no admite la aplicación posterior de Archivos de Log. El Backup Físico es bit a bit y sí soporta inyectar en bloque los Archive Logs (Roll-forward)."
    },
    {
      "q": "¿Qué define a los \"Redo Logs Online\"?",
      "a": "Ficheros rotativos preasignados en anillo; capturan modificaciones candentes reescribiéndose sobre sí mismos cíclicamente cuando se agotan."
    },
    {
      "q": "¿Qué misión tienen los \"Archive Logs (Logs Offline)\"?",
      "a": "Son copias blindadas de sólo lectura de los Redo Logs Online completados. No se borran nunca y retienen la secuencia histórica infinita requerida para recuperación catastrófica en frío."
    },
    {
      "q": "¿Por qué es inútil una Exportación SQL Pura para una contingencia Up-to-the-minute de rotura de hardware?",
      "a": "Carece de estructura subyacente física que permita al gestor de recuperación engarzar los bloques matemáticos del Log y reproducir transacciones al dedillo posteriores a la foto de exportación."
    },
    {
      "q": "En un Log Inmediato, ocurre Checkpoint(T2, T3 activas). T2 hace COMMIT y luego el servidor cae. ¿Qué pasará?",
      "a": "Se efectuará REDO(T2) porque culminó. Se aplicará UNDO(T3) analizando las modificaciones logradas de forma regresiva, porque T3 quedó en ascuas."
    },
    {
      "q": "¿Cuál es el paso más crucial del ciclo de salvaguarda de norma ISO/IEC 27001 (PDCA)?",
      "a": "La fase CHECK (Verificar). Simular de forma periódica e íntegra el procedimiento drástico de restauración de los datos en otro servidor aislado de pruebas."
    },
    {
      "q": "¿Cómo restituye la infraestructura utilizando Backups Incrementales?",
      "a": "Aplica el \"parche\" gigante inyectando primero la base del último Backup Completo seguido del último Backup Incremental generado (que alberga bloques divergentes)."
    },
    {
      "q": "Al ejecutar formalmente una fase \"UNDO\", ¿en qué sentido direccional se explora el fichero de log?",
      "a": "Se realiza cronológicamente \"hacia atrás\" (del final abajo, hacia el principio arriba), restableciendo metódicamente la \"Imagen Anterior\"."
    },
    {
      "q": "Al arrancar formalmente una fase \"REDO\", ¿en qué sentido se explora el Log?",
      "a": "Se evalúa secuencialmente \"hacia adelante\" (de arriba hacia abajo), reimplantando sólidamente la \"Imagen Posterior\" del registro en el bloque."
    },
    {
      "q": "A nivel de diseño de recuperación, ¿por qué es imperativa la dualidad Atomicidad y Durabilidad juntas?",
      "a": "La Atomicidad invoca los UNDO para demoler intentos sucios transitorios. La Durabilidad requiere de REDOs para fortificar transacciones legítimas que la lentitud del disco no pudo persistir."
    }
  ],
  "concurrencia": [
    {
      "q": "¿Cuál es la misión nuclear del Control de Concurrencia?",
      "a": "Asegurar que la ejecución simultánea de transacciones entrelazadas emita un resultado final intachable idéntico al que se conseguiría ejecutándolas aisladas en cola de a uno."
    },
    {
      "q": "Nombra los 4 problemas o anomalías universales generadas por carencia de Control.",
      "a": "Actualización Perdida (Lost Update), Lectura Sucia (Dirty Read), Análisis Incoherente / Lectura No Repetible, y Filas Fantasmas."
    },
    {
      "q": "Explica el desastre de \"Actualización Perdida\" (Lost Update).",
      "a": "Dos procesos leen concurrentemente la misma tupla, calculan valores en RAM, y al grabar a disco duro secuencialmente, el segundo destruye y sobreescribe de forma ciega todo el trabajo del primero."
    },
    {
      "q": "¿Por qué la \"Lectura Sucia\" (Dirty Read) quiebra fatalmente el modelo ACID?",
      "a": "Permite a una transacción (T2) nutrirse de las modificaciones efímeras de otra (T1) que no ha concluido. Si T1 ejecuta ROLLBACK, todo el trabajo y commit de T2 quedará basado en alucinaciones."
    },
    {
      "q": "Aparte de los errores numéricos, ¿qué causa una \"Lectura Sucia\" desde el punto de vista arquitectónico?",
      "a": "Crea \"Planificaciones No Recuperables\". El sistema queda incapacitado para anular limpiamente T1, ya que destruiría a una T2 que previamente fue declarada finalizada con éxito."
    },
    {
      "q": "Define \"Lectura No Repetible\" o Análisis Incoherente.",
      "a": "Transcurre cuando una misma transacción T1 lee dos veces la misma variable y arroja cifras incompatibles porque una transacción exógena logró empotrar de forma silenciosa un UPDATE intermedio con su COMMIT."
    },
    {
      "q": "Precisa qué particulariza a la anomalía \"Filas Fantasmas\".",
      "a": "Es una Lectura No Repetible pero de rango coleccional. T1 extrae una tabla de empleados, T2 añade sigilosamente otro individuo. Al re-ejecutar T1, se materializan o esfuman conjuntos de personas enteros."
    },
    {
      "q": "¿Qué convierte a una planificación en \"Serializable por Conflictos\"?",
      "a": "Que es algebraicamente reducible y equivalente a una ejecución secuencial serie pura. Matemáticamente, exige que su Grafo de Precedencia/Espera carezca totalmente de nudos cíclicos."
    },
    {
      "q": "Deduce cuándo dos operaciones se evalúan teóricamente como \"Acciones en Conflicto\".",
      "a": "Deben pertenecer a transacciones rivales diferentes, atacar exactamente sobre la misma tupla o variable común y, por lo menos una de las dos partes, ser de naturaleza de Escritura."
    },
    {
      "q": "Describe el funcionamiento del Grafo de Precedencia / Grafo de Espera.",
      "a": "Representa transacciones como nodos. Una flecha de T1 a T2 asiente que T1 aguarda a T2. Si la telaraña exhibe círculos cerrados (ciclos), el sistema decreta Interbloqueo (Deadlock)."
    },
    {
      "q": "¿En qué principios se sustenta el protocolo de bloqueo 2PL (Two-Phase Locking)?",
      "a": "Impone la segregación en 2 fases monolíticas: Crecimiento (la transacción sólo consigue nuevos bloqueos o promociona preexistentes) y Decrecimiento (sólo afloja bloqueos, y jamás solicita ninguno nuevo)."
    },
    {
      "q": "Diferencia estelar entre la especificación 2PL Estricta y la variante 2PL Rigurosa.",
      "a": "Estricto libera bloqueos pasivos compartidos (S) tempranamente guardando los (X) de escritura para el final. Riguroso atesora todos, negando liberar S o X hasta que se pronuncia la confirmación COMMIT."
    },
    {
      "q": "¿A qué denominamos \"Interbloqueo\" (Deadlock)?",
      "a": "Situación paradójica irresoluble en la que un grupo de transacciones se detiene de forma infinita esperando eternamente a que otra de la agrupación libere sus respectivos recursos encadenados."
    },
    {
      "q": "Las políticas de prevención Marcas de Tiempo castigan a T1 si bloquea a T2. Explica la norma \"Esperar-Morrer\" (Wait-Die).",
      "a": "Favorece a los ancianos. Si T_Vieja choca con bloqueo de T_Joven, T_Vieja aguarda cortésmente. Si T_Joven choca contra T_Vieja, T_Joven muere y aborta por su insolencia."
    },
    {
      "q": "Explica la técnica combativa \"Ferir-Esperar\" (Wound-Wait) frente a interbloqueos.",
      "a": "Si T_Vieja demanda el recurso de T_Joven, T_Vieja la \"hiere\" (Wound) induciendo el aborto fulminante de la T_Joven. Si T_Joven demanda a la T_Vieja, la T_Joven se subordina a esperar pasivamente."
    },
    {
      "q": "En Marcas de Tiempo elementales, define qué representan \"ML(A)\" y \"ME(A)\".",
      "a": "Son las etiquetas del dato A. ML(A) guarda la marca de tiempo \"M(T)\" de la transacción MÁS JOVEN que visualizó el dato. ME(A) guarda la M(T) de la más joven que lo sobrescribió."
    },
    {
      "q": "Algoritmo Marcas de Tiempo: ¿Por qué resulta abortada por un ROLLBACK la transacción T1 al leer un dato A que posee M(T1) < ME(A)?",
      "a": "Intenta escrutar al dato \"A\" de una manera desfasada en la historia; una transacción más moderna ya modificó permanentemente a \"A\". Provocaría lectura temporal contaminada e irracional."
    },
    {
      "q": "Detalla la función salvadora de la Regla de Thomas en la Escritura.",
      "a": "Si T1 solicita escribir pero su época es M(T1) < ME(A) (intento de modificar una tupla del pasado), se aborta la actualización IGNORANDO de forma indolora la orden, pero sin disparar un ROLLBACK general."
    },
    {
      "q": "Arquitectura Multiversión (MVCC): ¿Cuál es el principal axioma competitivo de Oracle mediante el uso del Undo Log?",
      "a": "Las transacciones escritoras (UPDATE) nunca obstruyen ni bloquean las lecturas concurrentes (SELECT), y viceversa. Optimiza la fluidez transaccional y suprime infinidad de Deadlocks."
    },
    {
      "q": "En MVCC, si una transacción T2 desea leer una tupla que posee varias copias/versiones almacenadas en el catálogo. ¿Cuál escoge exactamente?",
      "a": "Inspecciona las metadatas físicas para reclutar la versión que registre el ME (Marca Escritura) MÁS ELEVADO posible de todo el conjunto de valores que sean iguales o menores a su propio identificador M(T2)."
    },
    {
      "q": "MVCC de escritura: ¿Cuándo el motor admite exitosamente escribir sin abortos por colisiones temporales (rollback forzoso)?",
      "a": "Exclusivamente si corrobora que la identidad temporal de la transacción T es matemáticamente igual o superior a la Marca de Lectura ML del elemento (es decir, M(T) >= ML(A))."
    },
    {
      "q": "Consolidación MVCC: ¿Qué acción anatómica sucede si la escritura MVCC es válida y se aprueba exitosamente en memoria?",
      "a": "Se penaliza sobreescribir físicamente el bloque madre anterior. Se inyecta obligatoriamente la creación de una versión física completamente original y nueva encadenada en el soporte de almacenamiento."
    },
    {
      "q": "¿Cuál es la particularidad de una \"Escritura a Ciegas\" (Blind Write)?",
      "a": "Fenómeno admitido en SQL de enviar directamente sentencias de sustitución agresivas (UPDATE o DELETE incondicionales) sin haberse preocupado ni validado previamente la lectura del dato usando un SELECT."
    },
    {
      "q": "Nivel estándar \"READ COMMITTED\" del SGBD: ¿Cuál es el agujero de vulnerabilidad que permite y por qué motivo?",
      "a": "Abandona velozmente los bloqueos de lectura (S) línea por línea sin esperar al COMMIT general, promoviendo la materialización tolerada de las anomalías Lectura No Repetible y Filas Fantasmas."
    },
    {
      "q": "¿Cómo blindaríamos imperativamente un comando de lectura crítica SQL en entorno \"READ COMMITTED\" para evadir Lecturas No Repetibles?",
      "a": "Erigiendo un enclave pesimista adosando la cláusula innegociable \"FOR UPDATE\" en la terminación de la instrucción SELECT originaria."
    },
    {
      "q": "Concordancia Teórica: ¿Qué repercusión técnica acarrea la autorización explícita de \"Escrituras a Ciegas\" en un entorno relacional?",
      "a": "Habilita legalmente arquitecturas que, aun arrojando grafos circulares prohibidos de Seriabilidad por Conflictos, son catalogadas por la academia como Serializables por Vistas puras."
    },
    {
      "q": "Mecánica de Fallo en MVCC: Explica por qué una T_Vieja se anula si trata de modificar tupla A_1 donde ML(A_1) > M(T_Vieja).",
      "a": "Destruye las garantías de Aislamiento, dado que obligaría a reescribir de forma parasitaria la tupla madre que otra T_Moderna ya ha extraído e incorporado irreversiblemente a sus resultados locales."
    },
    {
      "q": "Distinción algorítmica pasiva frente a proactiva en Interbloqueos (Deadlocks).",
      "a": "La pasiva detiene cíclicamente el reloj forzando el escaneo del Grafo de Esperas Wait-For matando arbitrariamente a una víctima. La proactiva interviene anticipadamente mediante marcas (Wait-Die, Wound-Wait)."
    },
    {
      "q": "Control Multiversión (MVCC): Al crear una nueva versión T3(Valor=55), ¿qué metadatos iniciales adoptará irrevocablemente esta nueva fila?",
      "a": "Impondrá taxativamente como cota cronológica inicial de la nueva estructura: Marca_Lectura ML = 3 y Marca_Escritura ME = 3, congelando las magnitudes temporales relativas de origen de la transacción T3."
    },
    {
      "q": "Diferencia pragmática y de penetración entre los modos de Bloqueo Exclusivo (X) y Compartido (S).",
      "a": "El compartido (S) concede acceso concurrente pacífico para visualización masiva; el Exclusivo (X) despliega un monopolio hostil expulsando de forma obligatoria cualquier otra lectura paralela sobre dicha celda."
    },
    {
