...
- 🎯 **Guía de Resolución Definitiva**: Un nuevo entorno de tutoría intensiva (v1.1.1) que clasifica, disecciona y resuelve paso a paso problemas de exámenes reales. Extrae automáticamente la lógica de Markdown y la enriquece con alertas tácticas, renderizado Mermaid para grafos, soporte LaTeX para fórmulas y un formato impecable con fuente JetBrains Mono.
...
- 🎨 **Interfaz Premium**: Diseño oscuro profundo (`#0a0e17`) unificado en todo el ecosistema (Portal, Flashcards, Quiz, Apuntes y Guía), con efectos glassmorphism, sombras neon y un comportamiento de rebote nativo impecable.
